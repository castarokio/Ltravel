...
export interface TourismDestinationData {
  id: string;
  name: string;
  tagline: string;
  shortDesc: string;
...
export const tourismDestinations: TourismDestinationData[] = [
  {
    id: "maldives",
    name: "Les Maldives",
    ...
    itinerary: [
      ...
      },
      {
        ...
        desc: "Excursion guidée en bateau vers la réserve de biosphère de l'Atoll Baa (classée par l'UNESCO). Si les conditions de saison le permettent, vous aurez le privilège de nager avec des raies mantas géantes.",
        image: asset("local-coastal-resort.webp")
      },
      {
